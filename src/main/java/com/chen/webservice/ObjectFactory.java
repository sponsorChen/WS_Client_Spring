...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.chen.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.chen.com/", "helloWorldResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.chen.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.chen.com/", name = "helloWorldResponse")
